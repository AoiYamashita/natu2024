...
class Strtegy(Node):
    def __init__(self):
        ...
        self.poses = [np.array([1250,1250,np.pi*5/4]),"slide",np.array([1500,1500,np.pi*5/4]),"slide",np.array([1250,550,7/4*np.pi]),np.array([1500,300,7/4*np.pi]),"slide",np.array([1000,900,0]),np.array([1200,900,np.pi]),np.array([1000,900,np.pi]),"slide"]
        self.fase = 0
    def cb(self,data):
