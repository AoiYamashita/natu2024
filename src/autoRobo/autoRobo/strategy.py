...
class Strtegy(Node):
    def __init__(self):
        ...
        self.poses = [np.array([1250,1250,np.pi*5/4]),
                      "slide",
                      np.array([1500,1500,np.pi*5/4]),
                      "slide",
                      np.array([1300,600,7/4*np.pi]),
                      np.array([1500,300,7/4*np.pi]),
                      "slide",
                      np.array([1200,900,0.0]),
                      np.array([1500,900,np.pi/2.0]),
                      np.array([1500,900,np.pi]),
                      np.array([1200,900,np.pi]),
                      "slide",
                      np.array([1550,900,np.pi]),
                      "finish"]
        self.fase = 0
    def cb(self,data):
        ...
        if abs(delta[0]) < 30 and abs(delta[1]) < 30 and np.tan(delta[2]) < np.tan(np.pi/12):
            self.fase += 1
        else:
            V = Vector3()
